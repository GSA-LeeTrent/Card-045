...
--  left outer join hiring.mgs_mstr_adhoc_g_users        on  mgs_mstr_adhoc_g_users.user_id = mgs_mstr_adhoc_g_vacancy.vacancy_hr_manager 
  ...
  join hiring.mgs_mstr_adhoc_g_application  on     mgs_mstr_adhoc_g_cert_application.fk_an_organization_id      = mgs_mstr_adhoc_g_application.fk_an_organization_id
                                           ...
                                           and     mgs_mstr_adhoc_g_application.APPLICATION_SELECT_DATE >= '2021-10-01'
  and   	mgs_mstr_adhoc_g_cert_application.applicant_par_number is not null 
  and     mgs_mstr_adhoc_g_cert_application.applicant_par_number not REGEXP  '^(?!,)((, *)?([0-9]+[CU])\b)*$';
  ...
  and   
	(
		mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU]$'
		or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU]$'
	);
  ...
  and   
	(
		mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU]$'
		or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
		or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
        or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
		or  mgs_mstr_adhoc_g_cert_application.applicant_par_number  REGEXP  '^[0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU], [0-9]+[CU]$'
	);
